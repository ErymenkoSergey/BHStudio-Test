...
namespace Mirror.Examples.AdditiveLevels
{
    ...
    public class AdditiveLevelsNetworkManager : NetworkManager
    {
        ...
        public virtual void SetConfigPlayer(GameObject player)
        {
            if (_gameNetConfigurator.TryGetComponent(out INetConfigurable configurable))
            {
                _iNetConfig = configurable;
                _iNetConfig.TransferPlayer(player);
            }
            else
                Debug.Log("Null ref Config");
        }
    }
}
